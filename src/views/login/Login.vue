<template>
  <div>
    <div style=" margin-left: 5%; margin-top: 300px;width: 800px;">
      <p class="title">昆&nbsp;&nbsp;药&nbsp;&nbsp;商&nbsp;&nbsp;业&nbsp;&nbsp;管&nbsp;&nbsp;理&nbsp;&nbsp;系&nbsp;&nbsp;统</p>
      <p class="title">kpc business  management system</p>
    </div>
    <div
          ...
          if (valid) {
            ...
            this.$http.post('login', params).then(res => {
              if (res.data.code == 1000) {
                this.setTokenAction(res.data.data.jsession)
                setToken(res.data.data.jsession)//设置浏览器中的cookies
